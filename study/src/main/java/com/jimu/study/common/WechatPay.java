...
public class WechatPay {
    ...
    public static final String APP_ID = "wxd123456778902";

    /** 商户号（商户号ID） 11473623 */
    public static final String MCH_ID = "1234567890";

    /** API key（商户号里面的） 2ab9071b06b9f739b950ddb41db2690d */
    public static final String API_KEY = "2ab9071b06b9f739b950ddb41db2690d";

    /** 发起支付的Ip */
    public static final String CREATE_IP = "127.0.0.1";

    /** 回调地址（需要外网可以访问的IP） */
    public static final String  NOTIFY_URL = "127.0.0.1:9000/order/buyVip";
    ...
    public static final String APP_SECRET = "86ae4a77893342f7568947e243c84d9aa";
